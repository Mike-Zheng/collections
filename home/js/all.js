;(function () {
  ...
  ;(u = jQuery).fn.photoPlay = function (t) {
    ...
    return this.each(function () {
      ...
      1 == l[0].is_video ? u('#big-swiper-video').hide() : u('#big-swiper-video').show(),
  ...
  ;(a = jQuery),
    ...
    (a.fn.lazyloadImg = function (e) {
      ...
      function i() {
        ...
        r.each(function () {
          var e = a(this)
          if ((!l.skip_invisible || e.is(':visible')) && !a.abovethetop(this, l) && !a.leftofbegin(this, l))
            if (a.belowthefold(this, l) || a.rightoffold(this, l)) {
              if (++t > l.failure_limit) return !1
            } else e.trigger('appear'), c.trigger('lazyloadImg-appear', this), (t = 0)
        })
      }
      return (
        e &&
          (f !== e.failurelimit && ((e.failure_limit = e.failurelimit), delete e.failurelimit),
          f !== e.effectspeed && ((e.effect_speed = e.effectspeed), delete e.effectspeed),
          a.extend(l, e)),
        ...
        this.each(function () {
          var o = this,
            n = a(o)
          ;(o.loaded = !1),
            (n.attr('src') !== f && !1 !== n.attr('src')) || (n.is('img') && n.attr('src', l.placeholder)),
              ...
              this.loaded ||
                ...
                a('<img />')
                  .one('load', function () {
                    ...
                    ;(r = a(i)), l.load && ((t = r.length), l.load.call(o, t, l))
                  })
    ...
    (a.abovethetop = function (e, t) {
      var i = t.container === f || t.container === o ? c.scrollTop() : a(t.container).offset().top
      return i >= a(e).offset().top + t.threshold + a(e).height()
    }),
    (a.leftofbegin = function (e, t) {
      var i = t.container === f || t.container === o ? c.scrollLeft() : a(t.container).offset().left
