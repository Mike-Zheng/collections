    ...
    ;(s.prototype.resolve = function () {
      ...
      (s.prototype.load = function () {
        ...
        if (!(a.status >= $.LOADING)) {
          ...
          for (var d = (a._remain = c.length), e, f = 0; d > f; f++)
            (e = s.get(c[f])), e.status < $.LOADED ? (e._waitings[a.uri] = (e._waitings[a.uri] || 0) + 1) : a._remain--
      ...
      (s.prototype.fetch = function (a) {
        ...
        return !h || Y[h]
          ...
          : ((X[h] = !0),
            (Z[h] = [e]),
            B('request', (g = { uri: f, requestUri: h, onRequest: d, charset: u.charset })),
...
!(function () {
  ...
  function c(a, c, e) {
    ...
    d(g, c, f, a),
      f
        ? ((g.rel = 'stylesheet'), (g.href = a))
        : ((g.async = !0), (g.src = a), g.setAttribute('crossorigin', 'anonymous')),
      (p = g),
  ...
  function d(a, b, c, d) {
    ...
    return !c || (!v && g)
      ? (g
          ? ((a.onload = f),
            (a.onerror = function () {
              seajs.emit('error', { uri: d, node: a }), f()
            }))
          : (a.onreadystatechange = function () {
...
!(function () {
  ...
  ;(seajs.Module.preload = function (b) {
    ...
    (a.preload = (function () {
      ...
      return (
        (c += ' ' + b.cookie),
        c.replace(/(seajs-\w+)=1/g, function (b, c) {
          a.push(c)
        }),
        a
      )
...
!(function () {
  ...
  window.ENV = host.indexOf('dev') > -1 ? '.dev' : host.indexOf('debug') > -1 ? '.debug' : ''
